...
function EvaluationPage({
  ...
  // Calculate evaluation progress based on both drafts (localStorage) and completed (memory)
  ...
  const handleSubmitAll = async () => {
    ...
    try {
      ...
      // Wait a moment for the write to commit, then reload subjects
  ...
  return (
    <div style={styles.pageContainer}>
      ...
      <div style={styles.mainContent}>
        ...
        {/* Completion Card - Show when all evaluations are actually submitted */}
